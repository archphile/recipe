...
pacman -S alsa-utils mpd-archphile mpc mympd-archphile archphile-optimize-rpi upmpdcli-archphile shairport-sync brutefir alsacap librespot-archphile uhubctl squeezelite-archphile --noconfirm
